...
function MyApp({ Component, pageProps}) {
  ...
  // if (route.includes('?')) {
  //   newRoute ='https://miah.shop' + removeLetter(route, "?");
  // } else {
  //   newRoute ='https://miah.shop'+route;
  // }
  ...
  return (
    <>
      <Head>
        ...
        />
        <meta name="google-site-verification" content="_O4ZoZH9uhxxk8A3w5sagMP1LLlBvjrfG6wW1mpN1Js" />
        {/* <link rel="canonical" href ={newRoute} /> */}
      </Head>
      <Script
        id="fb-pixel"

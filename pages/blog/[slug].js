...
import { POST_BY_SLUG, ALL_POSTS, ALL_CATEGORIES } from "../../wp-lib/api";
import fetcher from "../../wp-lib/fetcher";
import CategoryList from "../../components/route/blog/CategoryList";

export default function BlogPost({ post, recentPosts, categories }) {
  return (
...
export async function getServerSideProps({ params }) {
  ...
  return {
    props: {
      ...
      recentPosts: postsRes.data.posts.nodes.slice(0, 5),

...
export default function Faq() {
  ...
  return (
    <>
      <Canonical />
      <StaticHeader title="FAQs - Your Questions Answered | MIAH" des="Find answers to frequently asked questions in FAQs at MIAH. Learn about ordering, shipping, returns and shopping from our collections." />

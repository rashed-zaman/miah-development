        ...
        <ul className="menu">
          <li className="has-mega-menu ">
            <Link
              ...
              className={route.pathname == "/profile/rewards" ? "active" : ""}
            >
              FEED
            </Link>
          </li>
          <li className="has-mega-menu">
            <Link
              ...
              className={
                route.pathname == "/profile/order-history" ? "active" : ""
              }
            >
              ORDERS
            </Link>
          ...
          <li className="has-mega-menu">
            <Link
              ...
              className={
                route.pathname == "/profile/address-book"
                  ? "active"
                  : route.pathname == "/profile/account-information"
                  ? "active"
                  : route.pathname == "/profile/cancle-order"
                  ? "active"
                  : route.pathname == "/profile/wish-list"
                  ? "active"
                  : ""
              }
            >

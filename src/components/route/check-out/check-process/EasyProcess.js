...
export default function EasyProcess({
  ...
  const FORM_VALIDATION = Yup.object().shape({
    ...
    address: isOtpSent ? Yup.string().required("Requird") : "",
  });
                ...
                {({ values, handleChange, setFieldValue }) => (
                  <Form>
                    <Grid container spacing={2} className="pb-5">
                      ...
                      {isOtpSent && (
                        <Grid size={12}>
                          <TextFieldWrapper
                            ...
                            onChange={handleChange}
                            onBlur={() => handleAddress(values.address)}
                          />
                        </Grid>
                      )}
                      ...
                      <Grid size={6} className="text-right pt-1">
                        <span
                          style={{
                            background: "#ffffff",
                            position: "relative",
                      ...
                      <Grid size={12}>
                        <Button
                          fullWidth
                          type="button"
                          onClick={() => setProcesstype("regular")}
                          variant="outlined"
                          size="large"
                          className="pt-3"
                        >
                          <KeyboardArrowLeftIcon /> Checkout Method
                        </Button>
                      </Grid>
                    </Grid>
                  </Form>

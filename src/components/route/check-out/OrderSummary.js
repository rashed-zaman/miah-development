      ...
      <List component="nav" aria-label="mailbox folders">
        ...
        >
          <Grid container spacing={0}>
            <Grid size={{ xs: 6 }}>{ProductLength} items</Grid>
        ...
        <ListItem
          sx={{ pb: { xs: "0", sm: "8px" }, pt: { xs: "0", sm: "8px" } }}
        >
          ...
          >
            <Grid container spacing={0}>
              ...
              <Grid item xs={6} className="text-right">
                <span className="text-danger">-Tk {shippingCharge}</span>
              </Grid>
            </Grid>
          </ListItem>
        ) : null} */}
        ...
        >
          <Grid container spacing={0}>
            <Grid size={{ xs: 6 }}>
              {type == "mobile drawer" ? <span>Total</span> : <b>Total</b>}
            </Grid>
            <Grid size={{ xs: 6 }} className="text-right">
              {type == "mobile drawer" ? (
                <>
                  {totalAmount +
                    ...
                    offerDiscount.discountValue -
                    creditDiscountObj.amount -
                    (offerDiscount.shippingFree ? shippingCharge : 0) -
                    couponDiscountObj.discountAmount}
                </>
              ) : (
                <b>

...
const ROOT_URL = "https://miah.shop";

/* ----------------------------------------
   Dynamic Metadata for SEO
----------------------------------------- */
export async function generateMetadata({ params, searchParams }) {
  const canonicalUrl = `${ROOT_URL}/contact-us`;
  ...
  return {
    title: "Contact Us - Get in Touch | MIAH",
    description:
      "Have questions? Visit contact us to reach MIAH for assistance with orders, shipping, returns, and more. We’re here to help with all your fashion needs!",
    alternates: {
...
export default function ContactUs() {
  ...
  return (
    <>
      ...
      <StaticHeader
        title="Contact Us - MIAH"
        des="Have questions? Visit contact us to reach MIAH for assistance with orders, shipping, returns, and more. We’re here to help with all your fashion needs!"
      />

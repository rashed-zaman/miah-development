    ...
    <>
      <section className="home-banner-section">
        <Box sx={{ display: { xs: "none",sm: "block"} }}>
          ...
          >
            <source
              src="https://d25xyv9ldicae3.cloudfront.net/media/home_16_07_24/miah_summer_desktop.mp4"
              type="video/mp4"
            />
          </video>
        </Box>
        ...
        <Box sx={{ display: { xs: "block",sm: "none"}}}>
          ...
          >
            <source
              src="https://d25xyv9ldicae3.cloudfront.net/media/home_16_07_24/miah_summer_desktop_mobile.mp4"
              type="video/mp4"
            />
          </video>
        </Box>

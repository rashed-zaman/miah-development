...
import AddressTypeUser from "../formUI/shipping/addressType/AddressTypeUser";
import AddressType from "../formUI/shipping/addressType/AddressType";
import DivisionUser from "../formUI/shipping/division/DivisionUser";
import Division from "../formUI/shipping/division/Division";
import CityUser from "../formUI/shipping/city/CityUser";
import City from "../formUI/shipping/city/City";
import AreaUser from "../formUI/shipping/area/AreaUser";
import Area from "../formUI/shipping/area/Area";
  ...
  return (
    <Box p={2}>
      ...
      <Grid container spacing={1}>
        ...
        <Grid item sm={6} xs={12}>
          {hasLoggedIn && defaultDivision !== "" ? (
            <DivisionUser defaultValue={defaultDivision} options={locations} />
          ) : (
